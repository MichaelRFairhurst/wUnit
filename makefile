...
LIBRARYFILES := $(filter-out Asserts TestResultReporter TableFileReader,$(wildcard lib/obj/*.o))
LIBRARYTABLES := $(filter-out Asserts TestResultReporter TableFileReader,$(wildcard lib/table/*.table))
TESTLIBRARYFILES :=
